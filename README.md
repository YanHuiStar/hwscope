...
- **验收清单**：17 项判定（含固件合规/OS-BMC 一致性/风扇冗余/PCIe 链路/CPU·内存自洽校验），条件驱动 N/A 计数，硬件概览自动生成配置单
...
| [docs/REPORT.md](docs/REPORT.md) | 报告与验收体系：四件套/17 项判定/条件驱动 N/A |
